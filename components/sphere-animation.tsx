...
export default function SphereAnimation() {
  ...
  return (
    <div className="relative flex items-center justify-center transition-colors duration-300 w-full h-96">
      <div className="animation-wrapper">
        <div className="sphere-animation" ref={sphereRef}>
          <svg
            className="sphere"
            viewBox="0 0 440 440"
            style={{ stroke: isDarkMode ? "rgba(80,80,80,.35)" : "#85ACFF" }}
          >
            <defs>
              <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
                <stop stopColor={isDarkMode ? "#373734" : "#CBDAFF"} offset="0%" />
                <stop stopColor={isDarkMode ? "#242423" : "#EBF1FF"} offset="50%" />
                <stop stopColor={isDarkMode ? "#0D0D0C" : "#F5F8FF"} offset="100%" />
              </linearGradient>
            </defs>
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="ai-card-box z-10">
              <div className="ai-loader-box">
                <div className="animation-word-box">
                  <span className="ai-word-text">Checking medication name</span>
                  <span className="ai-word-text">Matching insurance plan</span>
                  <span className="ai-word-text">Fetching PA criteria</span>
                  <span className="ai-word-text">Reviewing formulary data</span>
                  <span className="ai-word-text">Analyzing step therapy</span>
                  <span className="ai-word-text">Searching insurance portals</span>
                  <span className="ai-word-text">Parsing policy guidelines</span>
                  <span className="ai-word-text">Running AI analysis</span>
                  <span className="ai-word-text">Verifying diagnosis rules</span>
                  <span className="ai-word-text">Preparing final summary</span>
                </div>
              </div>
            </div>
          </div>
